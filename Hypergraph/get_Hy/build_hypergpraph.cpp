...
int main(int argc, char const *argv[])
{
    ...
    // 0.1//double STDP_1_time_1_cal_weight=0.00000804;
    // 0.25//double STDP_1_time_1_cal_weight=0.00002304;
    // 0.5//double STDP_1_time_1_cal_weight=0.0000405;
    // 0.75//double STDP_1_time_1_cal_weight=0.0000605;
    //double STDP_1_time_1_cal_weight=0.000084;// 1.0//4
    double STDP_1_time_1_cal_weight=0.00000806;// 1.0//8
    // double STDP_1_time_1_cal_weight=0.000008806;
    double Neuron_1_weight=0.0082;
    // double Neuron_1_weight=0.00874389;
    ...
    for (int i = 0; i < STDP_in_table.size(); i++)
    {
        ...
        Neuron_weight.push_back(Node_weight*1000);
    ...
    begin_vec.push_back(Neuron_weight.size());
    begin_vec.push_back(Neuron_weight.size());
    ...
    string addrs="hyper2.txt";
    record_res_hypergraph(res_hypergraph,addrs);
